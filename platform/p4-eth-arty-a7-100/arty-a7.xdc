...
## Green LEDs
set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS33}  [get_ports {leds_g[0]}]
set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33}  [get_ports {leds_g[1]}]
set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS33}  [get_ports {leds_g[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {leds_g[3]}]
